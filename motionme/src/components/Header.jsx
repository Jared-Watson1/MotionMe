    ...
    >
      ...
      <div className="flex space-x-2 md:space-x-4 items-center">
        ...
        <div className="relative inline-block text-left">
          <button
            type="button"
            className={`inline-flex justify-center gap-x-1.5 rounded-md px-2 py-1 md:px-3 md:py-2 text-sm md:text-lg font-semibold tracking-wider items-center ${
              isDarkMode
          ...
          {isMenuOpen && (
            <div
              className={`absolute right-0 z-10 mt-2 w-36 md:w-48 origin-top-right rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ${
            ...
            >
              <div className="py-1" role="none">
                <a
                  href="#"
                  className={`block px-4 py-2 text-sm md:text-lg font-semibold tracking-wider ${
                    isDarkMode
        ...
        <button
          onClick={toggleTheme}
          className="h-10 w-10 md:h-12 md:w-12 rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-700"
        >
          <svg
