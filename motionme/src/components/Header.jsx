      ...
      <div className="flex space-x-4 items-center">
        ...
        >
          <svg
            ...
            className="h-8 w-8 fill-current text-white hover:text-gray-400"
            viewBox="0 0 50 50"
          >
        ...
        <div className="relative inline-block text-left">
          <div>
            <button
              type="button"
              className="inline-flex justify-center gap-x-1.5 rounded-md bg-black px-3 py-2 text-lg font-semibold tracking-wider text-white hover:bg-gray-700"
              id="menu-button"
          ...
          {isMenuOpen && (
            ...
            >
              <div className="py-1" role="none">
                <a
                  href="#"
                  className="block px-4 py-2 text-lg font-semibold tracking-wider text-white hover:bg-gray-700"
                  role="menuitem"
                  tabIndex="-1"
                  id="menu-item-0"
                >
